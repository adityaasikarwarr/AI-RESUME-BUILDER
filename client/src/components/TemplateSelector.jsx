  ...
  const templates = [
    {
      ...
      name: "Classic",
      preview:
        "A clean , traditional resume layout that emphasizes clarity and professionalism.",
    },
    {
      id: "modern",
      name: "Modern",
      preview: "A contemporary resume design with a modern aesthetic.",
    },
    {
      id: "minimal-image",
      name: "Minimal Image",
      preview: "An innovative layout for creative professionals.",
    },
    {
      id: "minimal",
      name: "Minimal ",
      preview:
        "A sleek , minimalistic resume design that focuses on essential information.",
    },
  ];
  return (
